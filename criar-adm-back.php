...
if (!$achei){
    echo 'O Dominio nao existe';
    header('Location: criar-adm-front.php?retorno=' . urlencode('O Dominio nao existe'));
    exit;
}

// Criar EMAIL

$sql = "INSERT INTO ftpusers(nome, login, senha, gid, ativo, dir, shell, email,tipo, dominio_id) 
        VALUES ('$nome', '$username', '$senha', 15000, 's', '/home/$dominio/$username', '/bin/bash', '$email','admin' , '$dominio_id')";
...
header('Location: criar-adm-front.php?retorno=' . urlencode('ADM criado.'));
exit;
